...
const OrderSummary = () => {
  ...
  <div className="mt-10 pt-6 text-sm text-slate-500 border-t border-slate-200/70">
    <label className="font-medium text-neutral-900 text-sm" data-nc-id="Label">Discount code</label>
    <div className="flex mt-1.5">
      <input className="block w-full border outline-none border-neutral-200 focus:ring focus:ring-[#bae6fd80] focus:border-[#7dd3fc] bg-white disabled:bg-neutral-200 dark:disabled:bg-neutral-800 rounded-2xl text-sm font-normal h-10 px-4 py-3 flex-1" type="text" /><button className="text-neutral-700 border border-neutral-200 hover:bg-neutral-100 rounded-2xl px-4 ml-3 font-medium text-sm bg-neutral-200/70 w-24 flex justify-center items-center transition-colors">
        Apply
      </button>
    </div>
  </div>
  ...
  {/*Tax */}
  <div className="flex justify-between py-2.5">
    <span className="text-sm text-slate-600">Tax estimate</span><span className="font-semibold text-sm text-slate-900">$24.90</span>
  </div>
  {/* Order total */}
