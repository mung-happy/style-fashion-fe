                ...
                <div className="p-6 flex flex-col sm:flex-row items-start">
                    ...
                    <div className="sm:ml-8">
                        <h3 className="text-slate-700 flex">
                            <span className="uppercase tracking-tight">PAYMENT METHOD</span><svg fill="none" viewBox="0 0 24 24" strokeWidth="2.5" stroke="currentColor" className="w-5 h-5 ml-3 text-slate-900">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                            </svg>
                        </h3>
                        <div className="font-semibold mt-1 text-sm">
                            <span>Google / Apple Wallet</span><span className="ml-3">xxx-xxx-xx55</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div>
                        <div className="flex items-start space-x-4 sm:space-x-6">
                            {/* <div class="flex items-center text-sm sm:text-base pt-3.5">
                                          <input
                                              id="Credit-Card"
                                              class="focus:ring-action-primary text-primary-500 rounded-full border-slate-400 hover:border-slate-700 bg-transparent dark:border-slate-700 dark:hover:border-slate-500 dark:checked:bg-primary-500 focus:ring-primary-500 w-6 h-6"
                            ...
                            <div className="flex-1">
                                ...
                                <div className="mt-6 mb-4 space-y-3 sm:space-y-5 block">
                                    <div className="max-w-lg">
                                        <label className="nc-Label font-medium text-neutral-900 text-sm" data-nc-id="Label">Card number</label><input className="block w-full border outline-none border-neutral-300 focus:ring focus:ring-[#bae6fd80] focus:border-[#7dd3fc] bg-white disabled:bg-neutral-200 dark:disabled:bg-neutral-800 rounded-2xl text-sm font-normal h-11 px-4 py-3 mt-1.5" autoComplete="off" type="text" />
                                    </div>
                                    <div className="max-w-lg">
                                        <label className="nc-Label font-medium text-neutral-900 text-sm" data-nc-id="Label">Name on Card</label><input className="block w-full border outline-none border-neutral-300 focus:ring focus:ring-[#bae6fd80] focus:border-[#7dd3fc] bg-white disabled:bg-neutral-200 dark:disabled:bg-neutral-800 rounded-2xl text-sm font-normal h-11 px-4 py-3 mt-1.5" autoComplete="off" type="text" />
                                    </div>
                                    <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
                                        <div className="sm:w-2/3">
                                            <label className="nc-Label font-medium text-neutral-900 text-sm" data-nc-id="Label">Expiration date (MM/YY)</label><input className="block w-full border outline-none border-neutral-300 focus:ring focus:ring-[#bae6fd80] focus:border-[#7dd3fc] bg-white disabled:bg-neutral-200 dark:disabled:bg-neutral-800 rounded-2xl text-sm font-normal h-11 px-4 py-3 mt-1.5" autoComplete="off" placeholder="MM/YY" type="text" />
                                        </div>
                                        <div className="flex-1">
                                            <label className="nc-Label font-medium text-neutral-900 text-sm" data-nc-id="Label">CVC</label><input className="block w-full border outline-none border-neutral-300 focus:ring focus:ring-[#bae6fd80] focus:border-[#7dd3fc] bg-white disabled:bg-neutral-200 dark:disabled:bg-neutral-800 rounded-2xl text-sm font-normal h-11 px-4 py-3 mt-1.5" autoComplete="off" placeholder="CVC" type="text" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div>
                        <div className="flex items-start space-x-4 sm:space-x-6">
                            {/* <div class="flex items-center text-sm sm:text-base pt-3.5">
                                          <input   
                                              class="focus:ring-action-primary text-primary-500 rounded-full border-slate-400 hover:border-slate-700 bg-transparent dark:border-slate-700 dark:hover:border-slate-500 dark:checked:bg-primary-500 focus:ring-primary-500 w-6 h-6"
                                              type="radio" value="Internet-banking" name="payment-method"
                                              checked="">
                                          </div> */}
                            <div className="flex-1">
                                ...
                                <div className="mt-6 mb-4 block">
                                    ...
                                    <ul className="mt-3.5 text-sm text-slate-500 space-y-2">
                                        ...
                                        <li>
                                            Bank name:
                                            <span className="text-slate-900 font-medium">Example Bank Name</span>
                                        </li>
                                        <li>
                                            Account number:
                                            <span className="text-slate-900 font-medium">555 888 777</span>
                                        </li>
                                        <li>
                                            Sort code:
                                        ...
                                        <li>
                                            BIC:
                                            <span className="text-slate-900 font-medium">BIC/Swift</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div>
                        <div className="flex items-start space-x-4 sm:space-x-6">
                            {/* <div class="flex items-center text-sm sm:text-base pt-3.5"><input
                                              id="Wallet"
                                              class="focus:ring-action-primary text-primary-500 rounded-full border-slate-400 hover:border-slate-700 bg-transparent focus:ring-primary-500 w-6 h-6"
