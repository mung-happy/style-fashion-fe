  ...
  return (
    ...
    <div className="flex-shrink-0 flex items-start">
          <div className="relative rounded-full overflow-hidden flex">
            <img className="w-32 h-32 rounded-full object-cover z-0" src="https://ciseco-nextjs.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FImage-3.0c3c10f4.png&w=256&q=75" />
