      ...
      <div>
                        <div className="relative flex flex-col justify-between mb-12 nc-Section-Heading sm:flex-row sm:items-end lg:mb-14 text-neutral-900 dark:text-neutral-50">
                            <div className="flex flex-col items-center w-full mx-auto text-center">
                                <h2 className="justify-center text-3xl font-semibold md:text-4xl 2xl:text-5xl">Start exploring.</h2>
                            </div>
                        </div>
                        <nav className="relative flex justify-center w-full mb-12 text-sm nc-Nav lg:mb-14 md:text-base">
                        <ul className="flex p-1 overflow-x-auto bg-white rounded-full shadow-lg dark:bg-neutral-800 hiddenScrollbar">
                                <li className="relative nc-NavItem2">
