        ...
        <div className="list-blog grid grid-cols-1 gap-6 xl:grid-cols-3 lg:grid-cols-2">
            ...
            <div className="">
                <div className="relative overflow-hidden rounded-md">
                    <a href="" className="">
                    <img className=" hover:scale-110 transform transition-all duration-200 ease-linear w-full h-80" src={blog.image} alt="" />
                    </a>
                ...
                <div className="post-new p-1">
                    ...
                    <p className="my-line-2 text-lg font-thin sm:text-base">{blog.content}</p>
