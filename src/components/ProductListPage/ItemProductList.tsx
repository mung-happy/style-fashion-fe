...
const ItemProductList = (props: Props) => {
  return (
    <div className="relative cursor-pointer bg-transparent duration-200 hover:-translate-y-4 h-full justify-between">
      <div className="relative flex-shrink-0 bg-slate-50 rounded-3xl overflow-hidden z-1">
        <div className="flex w-full">
          <img
            src="https://ciseco-nextjs.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2F5.addcba21.png&w=828&q=75"
            alt="product"
        ...
        <div className="flex justify-between items-end">
          ...
          <div className="flex items-center">
            <div className="relative w-20 h-6">
              ...
              <div className="absolute text-[#fbbf24] left-0 bottom-0 h-full overflow-hidden w-[96%]">
                ★★★★★
              </div>
            </div>
            <span className="text-sm ml-1 text-slate-500">4.8</span>
          </div>
        </div>
      </div>
    </div>
